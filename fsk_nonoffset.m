...
for index=1:i
    ...
    temp2=0;
    for n=1:Kos
        s_est1(index,n)=(1/Kos)*r(index,n)*conj((cos(phase_init+theta_est1(index,n))+1j*sin(phase_init+theta_est1(index,n))));
        s_est2(index,n)=(1/Kos)*r(index,n)*conj((cos(phase_init+theta_est2(index,n))+1j*sin(phase_init+theta_est2(index,n))));
